// Generated on 2014-05-18 using generator-mobile 1.0.0-alpha.1
'use strict';
    ...
    grunt.initConfig({
        ...
        compass: {
            options: {
                ...
                require: ['compass', 'animation', 'rgbapng']
            },
            dist: {},
            server: {
                options: {
        ...
        usemin: {
            ...
            options: {
                // dirs: ['<%= yeoman.dist %>', '<%= yeoman.dist %>/images/backgrounds'],
                assetsDirs: ['<%= yeoman.dist %>/**/', '<%= yeoman.dist %>/images/backgrounds'],
                patterns: {
                    js: [
                      [/(background-1\.jpg)/g, 'Replacing reference to background-1.png']
                    ]
                }
            }
        },
